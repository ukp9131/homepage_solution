...
$data["info"] = $ukp->solution_table_cnt("board", $where_arr);
$data["list"] = $ukp->solution_table_list("board", $where_arr, array("start" => $page, "limit" => $limit));
...
$data["top_list"] = $ukp->solution_table_list("board", $where_arr);
...
$data["remap_header_text"] = "게시판관리({$data["category"]["title"]})";
