<style>
    ...
    .ukp__box_mobile > .ukp__form > .ukp__row > .ukp__title {
        font-size: 0.75rem;
        font-weight: bold;
    }
    .ukp__box_mobile > .ukp__form > .ukp__row > .ukp__content > .ukp__row {
        padding-top: 0.625rem;
        font-size: 0;
    }
    .ukp__box_mobile > .ukp__form > .ukp__row > .ukp__content > .ukp__row > .ukp__name {
        display: inline-block;
        vertical-align: middle;
        font-size: 1rem;
    }
    .ukp__box_mobile > .ukp__form > .ukp__row > .ukp__content > .ukp__row > .ukp__image {
        display: inline-block;
        height: 1.25rem;
        vertical-align: middle;
        cursor: pointer;
...
<div class="ukp__box_mobile">
    <form class="ukp__form ukp__js_mobile_form" method="post" action="_update_board.php">
        ...
        <div class="ukp__row">
            ...
            <div class="ukp__content">
                <?php foreach($data["file"] as $temp) { ?>
                    <div class="ukp__row ukp__js_mobile_file">
                        <div class="ukp__name"><?= $temp["origin_name"] ?></div>
                        <img src="image/times.svg" alt="" class="ukp__image" onclick="ukp__js_mobile.delete_file(this, '<?= $temp["file_idx"] ?>')">
                    </div>
                <?php } ?>
            </div>
        </div>
    ...
    var ukp__js_mobile = {
        delete_file: function(my, file_idx) {
            ...
            ukp__js_common.ajax("_delete_file.php", {
                ...
                if(data == "1") {
                    $(my).closest(".ukp__js_mobile_file").remove();
                } else if(data == "999") {
                    location.reload();
                }
            });
