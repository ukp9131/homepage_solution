...
<div class="ukp__box_content">
    <form class="ukp__form ukp__js_content_form" method="post" action="_insert_category.php">
            ...
            <div class="ukp__module_select">
                ...
                <select class="ukp__select" name="parent_category_idx">
                    ...
                    <?php foreach ($data["parent_category"] as $temp) { ?>
                        <option value="<?= $temp["category_idx"] ?>"><?= $temp["title"] ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
        <div class="ukp__row">
            <div class="ukp__module_input">
                ...
                <div class="ukp__content">
                    ...
                    <input class="ukp__input" type="text" name="file_name" required="">
        ...
        <div class="ukp__row">
            <div class="ukp__module_input">
                ...
                <div class="ukp__content">
                    <div class="ukp__before"></div>
                    <input class="ukp__input" type="text" name="manager_file_name">
                    <div class="ukp__after"></div>
                </div>
            </div>
        </div>
        ...
        <div class="ukp__row">
            <div class="ukp__module_input">
                ...
                <div class="ukp__content">
                    <div class="ukp__before"></div>
                    <input class="ukp__input" type="number" name="sort" value="0" required="">
                    <div class="ukp__after"></div>
                </div>
            </div>
        </div>
