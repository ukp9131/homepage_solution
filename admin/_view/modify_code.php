<style>
    ...
    .ukp__box_content > .ukp__form > .ukp__row > .ukp__module_input > .ukp__content > .ukp__readonly {
...
<div class="ukp__box_content">
    <form class="ukp__form ukp__js_content_form" method="post" action="_update_code.php">
        ...
        <div class="ukp__row">
            <div class="ukp__module_input">
                ...
                <div class="ukp__content">
                    <div class="ukp__before"></div>
                    <input class="ukp__input" type="text" name="content" value="<?= $data["code"]["content"] ?>" required="">
                    <div class="ukp__after"></div>
                </div>
            </div>
        </div>
        <div class="ukp__row">
            <div class="ukp__module_input">
                ...
                <div class="ukp__content">
                    <div class="ukp__before"></div>
                    <input class="ukp__input<?= $data["code"]["core_flag"] == "y" ? " ukp__readonly" : "" ?>" type="text" name="description" value="<?= $data["code"]["description"] ?>"  <?= $data["code"]["core_flag"] == "y" ? 'readonly=""' : 'required=""' ?>>
                    <div class="ukp__after"></div>
                </div>
            </div>
        </div>
