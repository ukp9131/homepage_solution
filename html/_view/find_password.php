...
<div class="ukp__box_content">
    <form action="_update_find_password.php" method="post" class="ukp__form ukp__js_content_form" autocomplete="off">
        ...
        <div class="ukp__input_list">
            ...
            <button class="ukp__module_btn" type="button" onclick="ukp__js_content.email_find_check(this)">인증</button>
        </div>
        <div class="ukp__input_list">
            <div class="ukp__module_input">
